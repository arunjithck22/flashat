...
import { useMakePodiumAdmin } from "@/app/hooks/podiums/useMakePodiumAdmin";
...
const MakeAdminConfirmationModal = ({
  ...
  const makeAdminMutation = useMakePodiumAdmin();
  ...
  return (
    <div className="flex flex-col w-full min-w-[250px] max-w-[200px] sm:min-w-72 sm:max-w-96 ">
      <div className="flex flex-col gap-2">
        <h3 className="text-md">{t("make_admin_confirmation")}</h3>
      </div>
